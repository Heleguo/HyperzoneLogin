...
public final class HyperRuntimeLibraries {
    ...
    public static final List<HyperDependency> CORE = List.of(
        EXPOSED_CORE,
        EXPOSED_JDBC,
        HIKARI_CP,
        SQLITE_JDBC,
    ...
    public static final List<HyperDependency> CONFIG_AND_EXPOSED = List.of(
        EXPOSED_CORE,
        CONFIGURATE_EXTRA_KOTLIN,
        CONFIGURATE_HOCON,
        CONFIGURATE_CORE,
    ...
    public static final List<HyperDependency> AUTH_OFFLINE = CONFIG_AND_EXPOSED;
    public static final List<HyperDependency> AUTH_YGGD = CONFIG_AND_EXPOSED;
    public static final List<HyperDependency> PROFILE_SKIN = CONFIG_AND_EXPOSED;
    public static final List<HyperDependency> DATA_MERGE = merge(CONFIG_AND_EXPOSED, List.of(H2));
    ...
    private static List<HyperDependency> merge(Collection<HyperDependency> left, Collection<HyperDependency> right) {
        LinkedHashSet<HyperDependency> merged = new LinkedHashSet<>();
        merged.addAll(left);
        merged.addAll(right);
